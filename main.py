...
LANGUAGES = {
    "en": {
        "welcome": "Welcome to the Boinkers Sticker Bot!\n\nThis bot is designed to help you easily claim stickers from the ongoing Boinkers sticker contest. To get started, simply follow the on-screen prompts to submit your claim.",
...
# Modified to only include the "Claim Missing Sticker" option per requested change.
